...
public class SecurePlayerPrefs
{
   ...
   */
    private static readonly string PRIVATE_KEY_PREFIX = "vjgf";
    private static readonly string PRIVATE_KEY_RAND = "aso";
    ...
    private static readonly string RAND_KEY = "vjgfasob";
    ...
    public static void Init()
    {
        ...
        else
        {
            ...
            string[,] keyandnewkeys = new string[2, 3] {
              {"User", "User1", "String"},
